...
class CicloEvaOutController extends Controller
{
    ...
    public function store(Request $request, Ciclo $ciclosos, $id)
    {
       ...
       $ciclosos=Ciclo::findOrFail($id);
        ...
        $ciclosos->evaluacion = $request->get('evaluacion');
        $ciclosos->evaluacionout = $request->get('evaluacionout');
        return back();
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        $tiempoa = $request->get('evaluacion');
        $tiempob = $request->get('evaluacionout');
        $tiempoA = $carbon1->diffInMinutes($tiempoa);
        $tiempoB = $carbon1->diffInMinutes($tiempob);

        $ciclosos->timeeva = $tiempoB - $tiempoA;
