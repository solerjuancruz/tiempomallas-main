...
use App\Models\CicloReunionOut;
...
class CicloReunionOutController extends Controller
{
    ...
    public function store(Request $request, Ciclo $ciclosos, $id)
    {
       ...
       $ciclosos=Ciclo::findOrFail($id);
        ...
        $ciclosos->reunionout = $request->get('reunionout');
        return back();
    ...
    public function update(Request $request, $id)
    {
        ...
        $tiempoa = $request->get('reunion');
        $tiempob = $request->get('reunionout');
        $tiempoA = $carbon1->diffInMinutes($tiempoa);
        $tiempoB = $carbon1->diffInMinutes($tiempob);

        $ciclosos->timereunion = $tiempoB - $tiempoA;
