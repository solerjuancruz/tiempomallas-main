...
class CicloLunchOutController extends Controller
{
    ...
    public function store(Request $request, Ciclo $ciclosos, $id)
    {
       ...
       $ciclosos=Ciclo::findOrFail($id);
        ...
        $ciclosos->almuerzo = $request->get('almuerzo');
    ...
    public function update(Request $request, $id)
    {
        ...
        $ciclosos->almuerzoout = $request->get('almuerzoout');

        $tiempoa = $request->get('almuerzo');
        $tiempob = $request->get('almuerzoout');
        $tiempoA = $carbon1->diffInMinutes($tiempoa);
        $tiempoB = $carbon1->diffInMinutes($tiempob);

        $ciclosos->timelunch = $tiempoB - $tiempoA;
