...
class CicloBreakOutController extends Controller
{
    ...
    public function show($id)
    {
        ...
        $carbon1 = new \Carbon\Carbon("2021-01-01 00:00:00");
        $ciclosos=Ciclo::findOrFail($id);
        return view('ciclobreakout.edit', compact('ciclosos','hoy','hora','llave','user_nombre','user_cedula',));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        $tiempoa = $request->get('breakin');
        $tiempob = $request->get('breakout');
        $tiempoA = $carbon1->diffInMinutes($tiempoa);
        $tiempoB = $carbon1->diffInMinutes($tiempob);

        $ciclosos->timebreak = $tiempoB - $tiempoA;
