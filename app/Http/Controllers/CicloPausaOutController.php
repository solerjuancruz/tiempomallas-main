...
class CicloPausaOutController extends Controller
{
    ...
    public function store(CicloRequest $request, Ciclo $ciclosos, $id)
    {
       ...
       $ciclosos=Ciclo::findOrFail($id);
        ...
        $ciclosos->pausas = $request->get('pausas');
    ...
    public function show($id)
    {
        ...
        $carbon1 = new \Carbon\Carbon("2021-01-01 00:00:00");
        $ciclosos=Ciclo::findOrFail($id);
        return view('ciclopausasout.edit', compact('ciclosos','hoy','hora','llave','user_nombre','user_cedula',));
    }
    ...
    public function edit(Request $request, $id)
    {
       ...
       $date = Carbon::now()->format('Y-m-d');
        ...
        $ciclosos->pausas = $request->get('pausas');
        $ciclosos->pausasout = $request->get('pausasout');
    ...
    public function update(Request $request, $id)
    {
       ...
       /*  $hora = Carbon::now()->format('H:i:s'); */
        ...
        $tiempoa = $request->get('pausas');
        $tiempob = $request->get('pausasout');
        $tiempoA = $carbon1->diffInMinutes($tiempoa);
        $tiempoB = $carbon1->diffInMinutes($tiempob);

        $ciclosos->timepausas = $tiempoB - $tiempoA;
