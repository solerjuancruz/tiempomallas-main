...
class CicloAveriaOutController extends Controller
{
    ...
    public function store(Request $request, Ciclo $ciclosos, $id)
    {
       ...
       $ciclosos=Ciclo::findOrFail($id);
        ...
        $ciclosos->daño = $request->get('daño');


        $ciclosos->dañoout = $request->get('dañoout');
    ...
    public function update(Request $request, $id)
    {
        ...
        $tiempoa = $request->get('daño');
        $tiempob = $request->get('dañoout');
        $tiempoA = $carbon1->diffInMinutes($tiempoa);
        $tiempoB = $carbon1->diffInMinutes($tiempob);

        $ciclosos->timedaño = $tiempoB - $tiempoA;
