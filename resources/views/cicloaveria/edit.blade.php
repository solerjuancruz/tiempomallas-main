                                            ...
                                            <div class="card">
                                                <div style="margin: 10px">
                                                    ...
                                                    <div class="col-sm-6">
                                                        ...
                                                        <form action="{{ url('/cicloaveria/' . $ciclosos->id) }}"
                                                            method="post" enctype="multipart/form-data">
                                                            {{ csrf_field() }}
                                                            @method('PATCH')

                                                            <h1 id="clock" style="font-size: 20px; margin-left:30px"></h1>
                                                            <input type="" id="daño" name="daño" class="form-control"
                                                                value="{{ $hora }}" required hidden>

                                                            <input type='submit' class="botones text-white btn btn-info"
                                                                value='Inicio' style="margin-left:100px" onclick="finalizaraveria()">
                                                                   
                                                                {{--function de finalizar turno --}}
                                                                <script>
                                                                  function finalizaraveria()
                                                                    {
                                                                        var confirsalida = confirm("Desea registrar Daño tecnico?");
