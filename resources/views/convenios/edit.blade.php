          ...
          <div class="card">
            ...
            <div class="card-body">
              ...
              <div class="row">
                ...
                <div class="col-sm-7">
                  <input type="text" class="form-control" name="title" placeholder="{{ $convenio->title }}" value="{{ $convenio->title }}" autofocus>
                  @if ($errors->has('title'))
              ...
              <div class="row">
                ...
                <div class="col-sm-7">
                  <input type="text" class="form-control" name="description" placeholder="{{ $convenio->description }}" value="{{ $convenio->description }}" autofocus>
