                                        ...
                                        <div class="card">
                                            <div style="margin: 10px">
                                                <strong id="tituloCards">
                                                    ...
                                                    <form action="{{ url('/ciclolunchout/' . $ciclosos->id) }}" method="post"
                                                        ...
                                                        <p class="card-text reloj-text">
                                                            ...
                                                            <e class="tiemp-text"> 
                                                                <input id="" name="" class="" value="{{ $ciclosos->almuerzo }}" disabled style="width:70px;background-color: transparent;border:none" >
                                                                <input id="" name="almuerzo" class="almuerzo" value="{{ $ciclosos->almuerzo }}" hidden >                                                                  
                                                            </e>
                                                        </small>
                                                    </p>
                                                        <h1 id="clock" style="font-size: 25px; margin-left:16px"></h1>
                                                        <input type="" id="almuerzoout" name="almuerzoout" class="form-control"
                                                        value="{{ $hora }}" required hidden>

                                                         <input type='submit' class="botones text-white btn btn-info"
                                                        value='Fin' style="margin-left:100px" onclick="finalizarlunch()">
                                                                   
                                                        {{--function de finalizar turno --}}
                                                        <script>
                                                          function finalizarlunch()
                                                            {
                                                                var confirsalida = confirm("Desea Finalizar Almuerzo?");
                                            ...
                                            <div style="margin: 10px">
                                                ...
                                                <div class="col-sm-6">
                                                    ...
                                                    <p class="card-text reloj-text"><small
                                                            class="text-muted2"><b>Fin:</b>
                                                            <e class="tiemp-text"> <input id="" name=""
                                                                    class="" value="{{ $ciclosos->pausasout }}"
                                                                    disabled
                                                                    style="width:70px;background-color: transparent;border:none">
                                                            </e>
                                                        </small>
                                                    ...
                                                    <p class="card-text reloj-text"><small
                                                            class="text-muted2"><b>Tiempo:</b>
                                                            <e class="tiemp-text"> <input id="" name=""
                                                                    class="" value="{{ $ciclosos->timepausas }}"
                                                                    disabled
                                                                    style="width:70px;background-color: transparent;border:none">
                                                            </e>
                                                        </small>
                                            ...
                                            <div style="margin: 10px">
                                                ...
                                                <div class="col-sm-6">
                                                    ...
                                                    <p class="card-text reloj-text"><small
                                                            class="text-muted2"><b>Fin:</b>
                                                            <e class="tiemp-text"> <input id="" name=""
                                                                    class="" value="{{ $ciclosos->evaluacionout }}"
                                                                    disabled
                                                                    style="width:70px;background-color: transparent;border:none">
                                                            </e>
                                                        </small>
                                            ...
                                            <div style="margin: 10px">
                                                ...
                                                <div class="col-sm-6">
                                                    ...
                                                    <p class="card-text reloj-text"><small
                                                            class="text-muted2"><b>Tiempo:</b>
                                                            <e class="tiemp-text"> <input id="" name=""
                                                                    class="" value="{{ $ciclosos->timeretro }}"
                                                                    disabled
                                                                    style="width:70px;background-color: transparent;border:none">
                                                            </e>
                                                        </small>
                                            ...
                                            <div style="margin: 10px">
                                                ...
                                                <div class="col-sm-6">
                                                    ...
                                                    <p class="card-text reloj-text"><small
                                                            class="text-muted2"><b>Fin:</b>
                                                            <e class="tiemp-text"> <input id="" name=""
                                                                    class="" value="{{ $ciclosos->reunionout }}"
                                                                    disabled
                                                                    style="width:70px;background-color: transparent;border:none">
                                                            </e>
                                                        </small>
                                                    ...
                                                    <p class="card-text reloj-text"><small
                                                            class="text-muted2"><b>Tiempo:</b>
                                                            <e class="tiemp-text"> <input id="" name=""
                                                                    class="" value="{{ $ciclosos->timereunion }}"
                                                                    disabled
                                                                    style="width:70px;background-color: transparent;border:none">
                                                            </e>
                                                        </small>
