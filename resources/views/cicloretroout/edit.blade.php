                                            ...
                                            <div class="card">
                                                <div style="margin: 10px">
                                                    ...
                                                    <div class="col-sm-6">
                                                        ...
                                                        <form action="{{ url('/cicloretroout/' . $ciclosos->id) }}"
                                                                ...
                                                                <small class="text-muted2"><b>Inicio:</b>
                                                                    <e class="tiemp-text">
                                                                        <input id="" name="" class=""
                                                                            ...
                                                                            style="width:70px;background-color: transparent;border:none">
                                                                        <input id="" name="retro" class="retro"
                                                                            value="{{ $ciclosos->retro }}" hidden>
                                                            ...
                                                            <input type="" id="retroout" name="retroout"
                                                                class="form-control" value="{{ $hora }}"
                                                                required hidden>

                                                            <input type='submit' class="botones text-white btn btn-info"
                                                                value='Fin' style="margin-left:100px" onclick="finalizarretro()">
                                                                   
                                                                {{--function de finalizar turno --}}
                                                                <script>
                                                                  function finalizarretro()
                                                                    {
                                                                        var confirsalida = confirm("Desea Finalizar Retro?");
