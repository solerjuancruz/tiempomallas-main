                                        ...
                                        <div class="card">
                                            <div style="margin: 10px">
                                                ...
                                                <div class="col-sm-6">
                                                    ...
                                                    <form action="{{ url('/ciclolunch/' . $ciclosos->id) }}"
                                                        method="post" enctype="multipart/form-data" class="form-horizontal">
                                                        {{ csrf_field() }}
                                                        @method('PATCH')
                                                        <h1 id="clock"  style="font-size: 20px; margin-left:41px"></h1>                                                       
                                                        <input type="" id="almuerzo" name="almuerzo" class="form-control" value="{{ $hora }}" required hidden>  

                                                        <input type='submit' class="botones text-white btn btn-info" value='Inicio' style="margin-left:100px" onclick="finalizarlunch()">
                                                                   
                                                        {{--function de finalizar turno --}}
                                                        <script>
                                                          function finalizarlunch()
                                                            {
                                                                var confirsalida = confirm("Desea registrar Almuerzo?");
