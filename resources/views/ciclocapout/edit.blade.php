                                                    ...
                                                    <div class="col-sm-6">
                                                        ...
                                                        <form action="{{ url('/ciclocapout/' . $ciclosos->id) }}" method="post" enctype="multipart/form-data" class="form-horizontal">
                                                            ...
                                                            <p class="card-text reloj-text">
                                                                ...
                                                                <e class="tiemp-text"> 
                                                                    <input id="" name="" class="" value="{{ $ciclosos->capacitacion }}" disabled style="width:70px;background-color: transparent;border:none">
                                                                    <input id="" name="capacitacion" class="capacitacion" value="{{ $ciclosos->capacitacion }}" hidden >  
                                                                    
                                                                </e>
                                                            </small>
                                                        </p>
                                                            <h1 id="clock" style="font-size: 23px; margin-left:5px"></h1>

                                                            <input type="" id="capout" name="capout" class="form-control"
                                                            value="{{ $hora }}" required hidden>

                                                        <input type='submit' class="botones text-white btn btn-info"
                                                            value='Fin' style="margin-left:100px" onclick="finalizarcapa()">
                                                                   
                                                            {{--function de finalizar turno --}}
                                                            <script>
                                                              function finalizarcapa()
                                                                {
                                                                    var confirsalida = confirm("Desea Finalizar Capacitacion?");
