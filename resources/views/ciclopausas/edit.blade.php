                                                ...
                                                <div style="margin: 10px">
                                                    ...
                                                    <div class="col-sm-6">                                                       
                                                        ...
                                                        <form action="{{ url('/ciclopausas/' . $ciclosos->id) }}"  method="post" enctype="multipart/form-data" class="form-horizontal">
                                                            ...
                                                            <input type="" id="pausas" name="pausas" class="form-control" value="{{ $hora }}" required hidden>  

                                                            <input type='submit' class="botones text-white btn btn-info" value='Inicio' style="margin-left:100px" onclick="finalizarpausa()">
                                                                   
                                                            {{--function de finalizar turno --}}
                                                            <script>
                                                              function finalizarpausa()
                                                                {
                                                                    var confirsalida = confirm("Desea registrar Pausas activas?");
