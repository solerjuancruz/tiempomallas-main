            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-body">
                            {{-- TITULO Y RELOJ --}}
                            <form action="{{ url('/ciclosalida/' . $ciclosos->id) }}" method="post"
                                    ...
                                    <div class="row" style="margin:3px">
                                        <div class="col-md-4">
                                            <div class="card">
                                                <div style="margin: 10px">
                                                    <strong>
                                                        <p class="card-text" style="margin-bottom: 10px">Evaluación
                                                        </p>
                                                    </strong>
                                                    <div class="col-sm-6">
                                                        <script>
                                                        ...
                                                        <form action="{{ url('/cicloevaout/' . $ciclosos->id) }}"
                                                                ...
                                                                <small class="text-muted2"><b>Inicio:</b>
                                                                    <e class="tiemp-text">
                                                                        <input id="" name="" class=""
                                                                            ...
                                                                            style="width:70px;background-color: transparent;border:none">
                                                                        <input id="" name="evaluacion" class="evaluacion"
                                                                            value="{{ $ciclosos->evaluacion }}" hidden>
                                                                    </e>
                                                                </small>
                                                            </p>
                                                            <h1 id="clock" style="font-size: 25px; margin-left:16px"></h1>
                                                            <input type="" id="evaluacionout" name="evaluacionout"
                                                                class="form-control" value="{{ $hora }}"
                                                                required hidden>

                                                            <input type='submit' class="botones text-white btn btn-info"
                                                                value='Fin' style="margin-left:100px" onclick="finalizareva()">
                                                                   
                                                                {{--function de finalizar turno --}}
                                                                <script>
                                                                  function finalizareva()
                                                                    {
                                                                        var confirsalida = confirm("Desea Finalizar Evaluación?");
