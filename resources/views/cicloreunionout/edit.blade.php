                                        ...
                                        <div class="col-md-4">
                                            <div class="card">
                                                <div style="margin: 10px">
                                                    ...
                                                    <div class="col-sm-6">
                                                        <form action="{{ url('/cicloreunionout/' . $ciclosos->id) }}"
                                                            ...
                                                            <p class="card-text reloj-text">
                                                                ...
                                                                <e class="tiemp-text"> 
                                                                    <input id="" name="" class="" value="{{ $ciclosos->reunion }}" disabled style="width:70px;background-color: transparent;border:none">
                                                                    <input id="" name="reunion" class="reunion" value="{{ $ciclosos->reunion }}" hidden >                                                                      
                                                                    </e>
                                                                </small>
                                                            </p>
                                                            ...
                                                            <input type="" id="reunionout" name="reunionout" class="form-control"
                                                            value="{{ $hora }}" required hidden>

                                                            <input type='submit' class="botones text-white btn btn-info"
                                                            value='Fin' style="margin-left:100px" onclick="finalizarreunion()">
                                                                   
                                                            {{--function de finalizar turno --}}
                                                            <script>
                                                              function finalizarreunion()
                                                                {
                                                                    var confirsalida = confirm("Desea Finalizar Reunion?");
