                                    ...
                                    <div class="row" style="margin:3px">
                                        ...
                                        <div class="col-md-4">
                                            <div class="card">
                                                <div style="margin: 10px">
                                                    <strong>
                                                        <p class="card-text" >Pausas Activas
                                                        </p>
                                                    </strong>
                                                    <div class="col-sm-6">
                                                        <script>
                                                        ...
                                                        <form action="{{ url('/ciclopausasout/' . $ciclosos->id) }}"
                                                            ...
                                                            <p class="card-text reloj-text">
                                                                ...
                                                                <e class="tiemp-text"> 
                                                                    <input id="" name="" class="" value="{{ $ciclosos->pausas }}" disabled style="width:70px;background-color: transparent;border:none">
                                                                    <input id="" name="pausas" class="pausas" value="{{ $ciclosos->pausas }}" hidden >                                                                      
                                                                 </e>
                                                                </small>
                                                            </p>
                                                            <h1 id="clock" style="font-size: 20px; margin-left:5px"></h1>
                                                            
                                                            <input type="" id="pausasout" name="pausasout" class="form-control"
                                                            value="{{ $hora }}" required hidden>

                                                            <input type='submit' class="botones text-white btn btn-info"
                                                            value='Fin' style="margin-left:100px" onclick="finalizarpausa()">
                                                                   
                                                            {{--function de finalizar turno --}}
                                                            <script>                                                                
                                                                function randomPausas() {
                                                                let min = 10;
                                                                let max = 14;
                                                              ...
                                                              function finalizarpausa()
                                                                {
                                                                    var confirsalida = confirm("Desea Finalizar Pausas activas?"+randomPausas());
