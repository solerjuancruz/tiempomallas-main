                                        ...
                                        <div class="card">
                                            <div style="margin: 10px">
                                                <strong id="tituloCards">
                                                    <p class="card-text">Capacitación
                                                    </p>
                                                </strong>
                                                <div class="col-sm-6">
                                                    <script>
                                                    ...
                                                    <form action="{{ url('/ciclocapa/' . $ciclosos->id) }}" method="post" enctype="multipart/form-data" class="form-horizontal"> {{ csrf_field() }}
                                                        @method('PATCH')
                                                        <h1 id="clock"  style="font-size: 20px; margin-left:35px"></h1>                                                       
                                                        <input type="" id="capacitacion" name="capacitacion" class="form-control" value="{{ $hora }}" required hidden>  

                                                        <input type='submit' class="botones text-white btn btn-info" value='Inicio' style="margin-left:100px" onclick="finalizarcapa()">
                                                                   
                                                        {{--function de finalizar turno --}}
                                                        <script>
                                                          function finalizarcapa()
                                                            {
                                                                var confirsalida = confirm("Desea registrar Capacitacion?");
