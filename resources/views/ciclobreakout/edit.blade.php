                            ...
                            <div style="margin-top: 10px">
                                <div class="row" style="margin:3px">
                                    ...
                                    <div class="col-md-4">
                                        <div class="card">
                                            <div style="margin: 10px">
                                                <form action="{{ url('/ciclobreakout/' . $ciclosos->id) }}" method="post"
                                                    ...
                                                    <div class="col-sm-6">
                                                        <p class="card-text reloj-text">
                                                            ...
                                                            <e class="tiemp-text"> 
                                                                <input id="" name="" class="" value="{{ $ciclosos->breakin }}" disabled style="width:70px;background-color: transparent;border:none">
                                                                <input id="" name="breakin" class="breakin" value="{{ $ciclosos->breakin }}" hidden >  
                                                        ...
                                                        <input type="" id="breakout" name="breakout" class="form-control"
                                                            value="{{ $hora }}" required hidden>

                                                        <input type='submit' class="botones text-white btn btn-info"
                                                            value='Fin' style="margin-left:100px" onclick="finalizarbreak()">
                                                                   
                                                            {{--function de finalizar turno --}}
                                                            <script>
                                                              function finalizarbreak()
                                                                {
                                                                    var confirsalida = confirm("Desea Finalizar break?");
